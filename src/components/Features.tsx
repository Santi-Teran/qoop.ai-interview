...
const features = [
  {
    ...
    description: "Monitor your habits and see your daily progress.",
  },
  {
    icon: <Clock size={32} />,
    title: "Reminders",
    description: "Stay consistent with customizable habit reminders.",
  },
  {
    icon: <TrendingUp size={32} />,
    title: "Growth Insights",
    description: "Analyze trends and improve your habits over time.",
  },
  {
    icon: <BarChart size={32} />,
    title: "Detailed Analytics",
    description: "Visualize your progress with insightful reports.",
  },
  {
    icon: <Shield size={32} />,
    title: "Secure Data",
  ...
  },
  {
    ...
    title: "Daily Streaks",
    description: "Stay motivated with streak-based tracking.",
  },
];
